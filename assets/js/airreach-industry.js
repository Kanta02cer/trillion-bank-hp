...
(function () {
  ...
  var INDUSTRIES = {
    restaurant: {
      ...
      hero_generic: 'このあたりで探しているお客さんに、どれくらい選ばれている？',
      hero_branded: 'お店の名前で調べられたとき、どんな情報が見えている？',
      demand_label: 'この言葉で探している人',
      demand_meaning: 'この地域・ジャンルのお店を探しているお客さんの目安（月）',
      now_label: '今、選ばれそうな度合い',
      now_meaning: '検索・お店情報・口コミ・ホームページなどから見たいまの位置',
      after_label: '直したあとの目安',
      after_meaning: '足りない情報を整えた場合の、選ばれそうな度合いの目安',
      outcome_label: '予約',
    ...
    clinic: {
      ...
      hero_generic: 'この施術を探している人に、どれくらい選ばれている？',
      hero_branded: 'クリニック名で調べられたとき、どんな情報が見えている？',
      demand_label: 'この言葉で探している人',
      demand_meaning: 'この施術・地域で探している人の目安（月）',
      now_label: '今、選ばれそうな度合い',
      now_meaning: '検索・公式情報・症例・よくある質問などから見たいまの位置',
      after_label: '直したあとの目安',
      after_meaning: '足りない情報を整えた場合の、選ばれそうな度合いの目安',
      outcome_label: '予約・相談',
    ...
    b2b: {
      ...
      demand_label: 'この言葉で探している人',
      demand_meaning: 'この課題・サービスを探している人の目安（月）',
      now_label: '今、選ばれそうな度合い',
      now_meaning: '検索・サービス説明・事例・よくある質問などから見たいまの位置',
      after_label: '直したあとの目安',
      after_meaning: '足りない情報を整えた場合の、選ばれそうな度合いの目安',
      outcome_label: '問い合わせ',
    ...
    media: {
      ...
      demand_label: '名前で探している人',
      demand_meaning: '会社名・サービス名などで探している人の目安（月）',
      now_label: 'いま伝わっている度合い',
      now_meaning: '公式サイトや記事の情報が、どれくらい整っているか',
      after_label: 'いま記事から見えている割合',
      after_meaning: '指定した記事が答えの中で使われた割合の目安',
      outcome_label: '記事が使われやすくなったあとの目安',
      outcome_meaning: '記事が使われやすくなるよう整えた場合の目安（保証なし）',
    ...
    other: {
      ...
      demand_label: 'この言葉で探している人',
      demand_meaning: '関連する言葉で探している人の目安（月）',
      now_label: '今、選ばれそうな度合い',
      now_meaning: '検索・ホームページの情報などから見たいまの位置',
      after_label: '直したあとの目安',
      after_meaning: '情報を整えた場合の、選ばれそうな度合いの目安',
      outcome_label: '問い合わせ',
      outcome_meaning: '現在の訪問数や問い合わせ率をもとにした参考値',
      impact_current_label: 'いまの問い合わせ',
      default_mode: 'generic_search',
